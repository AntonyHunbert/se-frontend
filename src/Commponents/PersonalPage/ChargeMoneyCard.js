...
import styles from "../Comment/CommentPage.module.css";
import { CloseOutlined, UploadOutlined } from "@ant-design/icons";
import { Row, Col, Upload, message, Button, Rate, Form, InputNumber } from "antd";
            ...
            <div className={styles.commentCard}>
                ...
                <div className={styles.commentBox}>
                    ...
                    <Row>
                        ...
                        <Col span={6}>
                            <InputNumber onChange={changeMoney} ></InputNumber>
                        </Col>
                        <Col span={6}>
                            <div>虚拟货币:账户余额=1:1</div>
                        </Col>
